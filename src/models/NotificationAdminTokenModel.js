...
const NotificationAdminToken = new Schema({
...
NotificationAdminToken.pre(['updateOne', 'findOneAndUpdate'], function(next) {
...
module.exports = mongoose.model('notificationAdminToken', NotificationAdminToken)