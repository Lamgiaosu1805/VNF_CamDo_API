...
const YeuCauNapTien = new Schema({
    customerId: { type: String, required: true },
    soTienNap: { type: Number, required: true },
...
YeuCauNapTien.pre(['updateOne', 'findOneAndUpdate'], function(next) {
...
module.exports = mongoose.model('yeuCauNapTien', YeuCauNapTien)