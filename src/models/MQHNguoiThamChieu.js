...
const MQHNguoiThamChieu = new Schema({
    tenMQH: { type: String, required: true },
...
MQHNguoiThamChieu.pre(['updateOne', 'findOneAndUpdate'], function(next) {
...
module.exports = mongoose.model('mqhNguoiThamChieu', MQHNguoiThamChieu)